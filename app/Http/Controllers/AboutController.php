...
class AboutController extends Controller
{
    ...
    public function index()
    {
        ...
        $aboutData = [
            ...
            'history' => 'Founded in 2010, Pinvegan has grown from a small local fruit stand to a trusted supplier for events, restaurants, and health-conscious individuals across the region.',
            ...
            'team' => [
                [
                    ...
                    'bio' => 'With over 20 years of experience in the fruit industry, David founded Pinvegan with a vision to bring the freshest fruits to customers.',
                ],
                [
                    'name' => 'Sarah Williams',
