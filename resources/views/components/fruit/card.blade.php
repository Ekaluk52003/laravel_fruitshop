...
<div class="overflow-hidden bg-white px-8 rounded-lg shadow-md transition-transform duration-300 dark:bg-gray-800 hover:shadow-lg hover:-translate-y-1">
    <div class="overflow-hidden h-48">
        @if($fruit->image)
            <img src="{{ asset($fruit->image) }}" alt="{{ $fruit->name }}" class="w-full h-full">
        @else
